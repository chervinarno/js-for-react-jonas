# Desctructuring, Rest, Spread and Literals
...
> This operator was introduced in JS to solve a problem of short-circuiting that happens when the value is zero (`0`) or an empty string (`''`)
